...
var date = new Date().toLocaleString('en-in', options)
...
/*Routing the individual post pages using Route Parameters from Express */
app.get("/posts/:postId", function(req, res){
  ...
  blogPost.findOne({_id: requestedPost }, function(err, foundPost){
    if(err)
      console.log(err)
    else{
      res.render("post", {
